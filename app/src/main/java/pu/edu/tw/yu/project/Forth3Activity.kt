...
class Forth3Activity : ComponentActivity() {
...
@Composable
fun Greeting43(name: String, modifier: Modifier = Modifier) {
    ...
    Column {
        ...
        Column (modifier = Modifier
            ...
            Button(onClick = {appear = !appear
                var it = Intent(context, Forth4Activity::class.java)
                context.startActivity(it)
            },
    ...
    Row {
        Button(
            ...
            onClick = {
                var it = Intent(context, Forth2Activity::class.java)
                context.startActivity(it)
            },
